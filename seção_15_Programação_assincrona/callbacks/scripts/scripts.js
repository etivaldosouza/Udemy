...
/*
    na programação assincrona vc tem um codigo que é executado fora do fluxo normal do programa ou seja ele é executado num momento futuro como acontece na função setTimeout. vale salientar que no caso da funçao setTimeou ela nao trava o código, ou seja, o programa segue o fluxo normal e após a execução do fluxo normal do programa função setTimout é executada. por isso é assincrona, pois, ela nao trava o programa mas sim é executada em momento futuro após o fluxo normal do programa.
